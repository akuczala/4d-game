...
where V : VectorTrait
{
	...
	pub fn new(transform : &Transform<V>) -> Camera<V> {
		Camera{
			heading : V::M::id(),
	...
	pub fn turn(&mut self, transform: &mut Transform<V>, axis1 : VecIndex, axis2 : VecIndex, speed_mult : Field) {
	...
	pub fn tilt(&mut self, transform: &mut Transform<V>, axis1 : VecIndex, axis2 : VecIndex, speed_mult : Field) {
