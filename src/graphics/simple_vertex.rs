...
//         .into_iter()
//     }
//     fn line_to_gl_arr<V: VectorTrait>(maybe_line: &Option<DrawLine<V>>) -> [Self ; 6] {
//         //Self::line_to_gl(maybe_line).into_iter()
//         // match maybe_line {
//         //     Some(draw_line) => draw_line
//         //         .get_draw_verts()
...
//         // }
//         // TODO: debug
//         [Self::NO_DRAW, Self::NO_DRAW, Self::NO_DRAW, Self::NO_DRAW, Self::NO_DRAW, Self::NO_DRAW]
//     }
// }
