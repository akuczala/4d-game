...
use crate::{vector::{VectorTrait, Field}, ecs_utils::{Componentable, SystemName}, components::{Camera, Transform, Player, Cursor, Shape, ShapeClipState, ShapeType, ClipState, BBall}};

use super::{DrawLineList, transform_draw_line, DrawLine, draw_cursor, update_shape_visibility, ShapeTexture, calc_shapes_lines, clipping::{calc_in_front_pair, InFrontArg, calc_in_front}, draw_line_collection::{DrawLineCollection, draw_collection}};
...
impl SystemName for TransformDrawLinesSystem<()> {const NAME: &'static str = "transform_draw_lines";}
...
impl SystemName for DrawCursorSystem<()> {const NAME: &'static str = "draw_cursor";}
...
impl SystemName for VisibilitySystem<()> {const NAME: &'static str = "visibility";}
...
impl SystemName for CalcShapesLinesSystem<()> {const NAME: &'static str = "calc_lines";}
...
impl SystemName for InFrontSystem<()> {const NAME: &'static str = "in_front";}
...
impl SystemName for DrawLineCollectionSystem<()> {const NAME: &'static str = "line_collection_system";}